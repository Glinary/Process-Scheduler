...
1. Type the command `g++ -std=c++20 ConsoleManager.cpp MainConsole.cpp Process.cpp BaseScreen.cpp AConsole.cpp Main.cpp Scheduler.cpp ThreadPool.cpp -o startt`
